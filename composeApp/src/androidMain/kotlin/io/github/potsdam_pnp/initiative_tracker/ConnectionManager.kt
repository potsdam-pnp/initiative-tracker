...
class ConnectionManagerAndroid(val context: Context, val repository: Repository<Action, State>) :
  ConnectionManager() {
                      ...
                      connectionInformation =
                        ConnectionInformation(
                          ...
                          hosts =
                            ...
                            else listOf(service.host.toString().drop(1)),
                        ),
                    )

                  serviceInfoState.update { it + (service.serviceName to info) }
                }
